...
// ── Gallery photos ─────────────────────────────────────────
const GALLERY = [
  { src: "/images/crowns-lp/gallery-05.webp", tag: "Full Arch Restoration",    note: "Severely broken teeth → complete porcelain crowns, same visit" },
  { src: "/images/crowns-lp/gallery-04.webp", tag: "Full Smile Makeover",      note: "Crowded, damaged teeth → natural-looking full arch crowns" },
  { src: "/images/crowns-lp/gallery-01.webp", tag: "Upper Arch Crowns",        note: "Missing & failing teeth → full upper arch restoration" },
  { src: "/images/crowns-lp/gallery-02.webp", tag: "Crown Restoration",        note: "Failing crowns & decay → new porcelain crowns, one appointment" },
  { src: "/images/crowns-lp/gallery-03.webp", tag: "Porcelain Crowns",         note: "Worn, cracked teeth → perfect porcelain crowns" },
  { src: "/images/crowns-lp/gallery-06.webp", tag: "Smile Transformation",     note: "Discolored & decayed → bright, natural smile restored" },
  { src: "/images/crowns-lp/gallery-07.webp", tag: "Complete Smile Rebuild",   note: "Severely worn dentition → full-arch crown restoration" },
  { src: "/images/crowns-lp/gallery-08.webp", tag: "Front Crown Restoration",  note: "Chipped front teeth → seamless porcelain crown match" },
];
